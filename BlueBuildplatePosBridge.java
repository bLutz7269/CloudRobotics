...
@Autonomous(name="BlueBuildplatePos:Bridge", group="Linear Opmode")

public class BlueBuildplatePosBridge extends LinearOpMode {
    ...
    public void turnToDegreeFast(double desiredEndRotation) {
        ...
        while ((! rotationBalisticProfile.isDone() || imu.getAngularVelocity().xRotationRate > rotationBalisticProfile.getEnd_power() * 90)
                && opModeIsActive()) {
    ...
    public void runOpMode(){
        ...
        while (opModeIsActive()) {
            rotationBalisticProfile = buildplateProfile;
